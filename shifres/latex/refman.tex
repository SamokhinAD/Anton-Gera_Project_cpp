...
\fi
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Anton-\/\+Gera\+\_\+\+Project\+\_\+2sem},%
      pdfsubject={}%
    }
...
\begin{document}
  ...
  \vspace*{7cm}
  \begin{center}%
  {\Large Anton-\/\+Gera\+\_\+\+Project\+\_\+2sem}\\
  \vspace*{1cm}
...
\chapter{Файлы}
\input{_affin___shifr_8h}
\input{_affin___shifr_8h_source}
\input{doctest_8h}
\input{doctest_8h_source}
\input{main_8cpp}
\input{_r_s_a_8h}
\input{_r_s_a_8h_source}
\input{tests_8cpp}
\input{_vij_8h}
\input{_vij_8h_source}
