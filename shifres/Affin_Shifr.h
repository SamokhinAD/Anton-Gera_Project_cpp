...
/**
 * @brief Основная функция для выполнения операций аффинного
 ...
 * @return Результат криптографической операции (зашифрованный или
...
string main_Aff(string alphabet_vvod, string key_vvod, string text_vvod,
  ...
  cout << "1. Алфавит может состоять из любого количества любых символов;"
       << endl;
  cout << "2. Ключ вводится как пара положительных чисел через пробел - числа "
          "не должны превышать размерность алфавита, первое число должно быть "
          "взаимно простым с размерностью алфавита;"
       << endl;
